        ...
        >
          <div className="max-w-4xl w-full flex flex-col items-center text-center space-y-12">
            ...
            >
              ...
              <Button asChild variant="outline" size="lg" className="flex-1 rounded-[1.25rem] h-16 border-2 font-black uppercase text-xs tracking-[0.2em] hover:bg-primary/10 hover:border-primary/40 transition-all active:scale-95 shadow-lg bg-card/50 backdrop-blur-md group">
